-- Datos de demostracion: 5 tecnicos, 6 tipos de servicio, 15 solicitudes con
-- fechas y estados realistas para que las capturas de pantalla del entregable
-- se vean como un sistema en uso real, no como datos de prueba.
